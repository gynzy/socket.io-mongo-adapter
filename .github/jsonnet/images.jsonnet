{
  ...
  default_job_image: 'alpine:3.20.0',
  ...
  default_backend_nest_image: 'node:20.12.1',
  ...
  default_python_image: 'python:3.12.1',
  default_pulumi_node_image: 'node:18',
  job_poster_image: 'europe-docker.pkg.dev/gynzy-test-project/public-images/docker-images_job-poster:v1',
  newrelic_deployment_marker_image: 'newrelic/deployment-marker-action@v2.5.0',
}
